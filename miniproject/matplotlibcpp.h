  ...
  namespace detail {
    ...
    struct _interpreter {
      ...
      PyObject * safe_import(PyObject * module, std::string fname) {
        ...
        if (!fn)
          throw std::runtime_error(std::string("Couldn't find required function: ") +
                                   fname);
...
// a non-numpy alternative for `detail::get_2darray()`.
  ...
  void imshow(const cv::Mat & image,
    ...
    detail::imshow(
        image2.data, npy_type, image2.rows, image2.cols, image2.channels(), keywords);
  }
#endif  // WITH_OPENCV
#endif  // WITHOUT_NUMPY
  ...
  void text(Numeric x, Numeric y, const std::string & s = "") {
    ...
    PyObject * res =
        PyObject_CallObject(detail::_interpreter::get().s_python_function_text, args);
    if (!res)
  ...
  inline void colorbar(PyObject * mappable = NULL,
    ...
    if (mappable == NULL)
      throw std::runtime_error("Must call colorbar with PyObject* returned from an "
                               "image, contour, surface, etc.");
    PyObject * args = PyTuple_New(1);
  ...
  inline long figure(long number = -1) {
    ...
    if (number == -1)
      ...
      res =
          PyObject_CallObject(detail::_interpreter::get().s_python_function_figure, args);
      Py_DECREF(args);
    }
  ...
  void ylim(Numeric left, Numeric right) {
    ...
    PyObject * res =
        PyObject_CallObject(detail::_interpreter::get().s_python_function_ylim, args);
    if (!res)
  ...
  void xlim(Numeric left, Numeric right) {
    ...
    PyObject * res =
        PyObject_CallObject(detail::_interpreter::get().s_python_function_xlim, args);
    if (!res)
  ...
  inline void axis(const std::string & axisstr) {
    ...
    PyObject * res =
        PyObject_CallObject(detail::_interpreter::get().s_python_function_axis, args);
    if (!res)
      throw std::runtime_error("Call to title() failed.");
  ...
  inline void grid(bool flag) {
    ...
    PyObject * res =
        PyObject_CallObject(detail::_interpreter::get().s_python_function_grid, args);
    if (!res)
  ...
  inline void pause(Numeric interval) {
    ...
    PyObject * res =
        PyObject_CallObject(detail::_interpreter::get().s_python_function_pause, args);
    if (!res)
  ...
  inline void save(const std::string & filename) {
    ...
    PyObject * res =
        PyObject_CallObject(detail::_interpreter::get().s_python_function_save, args);
    if (!res)
  ...
  inline void tight_layout() {
    PyObject * res =
        PyObject_CallObject(detail::_interpreter::get().s_python_function_tight_layout,
                            detail::_interpreter::get().s_python_empty_tuple);
